...
paramAnt <- par(no.readonly = TRUE)
par(mar = paramAnt$mar + c(5, 0, 0, 0))
gr_carr <- barplot(tbl_carrP, las = 2, ylim = c(0, 100), col = "#002e8b")

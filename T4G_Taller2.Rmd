...
Seguramente el género no influye mucho, pero pensamos que mientras más conspiraciones falsas el estudiante haya considerado como verdaderas, es más propenso a tener un PAPA bajo, pues creemos que las personas que respondieron las conspiraciones correctamente cuentan con un espíritu de investigación que tal vez una persona que la respondió incorrectamente no tenga.
...
##### Resumen numérico del PAPA para las personas del género femenino que en tres conspiraciones falsa

```{r, echo = FALSE}
summary(conspiraciones3M$Q08_PAPA)
```

##### Resumen numérico del PAPA para las personas del género femenino que en cuatro conspiraciones falsa

```{r, echo = FALSE}
summary(conspiraciones4M$Q08_PAPA)
```

##### Resumen numérico del PAPA para las personas del género femenino que en cinco conspiraciones falsa

```{r, echo = FALSE}
summary(conspiraciones5M$Q08_PAPA)
```

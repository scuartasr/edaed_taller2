...
table(enc_hombres$maths, intervalos_tiempohom,dnn = c("# Respuestas correctas",
                                                      "Intervalos de tiempo empleado [min]"))
```
...
table(enc_otrog$maths, intervalos_tiempog,dnn = c("# Respuestas correctas",
                                                      "Intervalos de tiempo empleado [min]"))
```
...
En general, se observó que el estrato 
